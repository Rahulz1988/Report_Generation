...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const columnMapping = {
    ...
    "English (Max. 12)": "Verbal Ability (Max 12)", // Map English to Verbal Ability
        "Quantitative Ability (Max. 12)": "Quantitative Ability (Max 12)",
        "Logical Reasoning (Max. 12)": "Logical Reasoning (Max 12)",
        "General Knowledge (Max. 12)": "General Knowledge (Max 12)",
        "Computer Awareness (Max. 12)": "Computer Awareness (Max 12)",
        "Overall Score (Max. 60)": "Overall Score (Max 60)",
        "Status": "Status",
